    ...
    content = (
        ...
        <div className="lobby container">
          <div className="lobby settings-container">
            ...
            <button ref={copyButtonRef} onClick={copyGameCode} className="button" type="button">
              Copy GameId
            </button>
          ...
          <div className="lobby players-container">
            <div className="lobby playersTable-title">{players.length}/{gameSettings.maxPlayers} Players in the Lobby
            </div>
            ...
            <button onClick={startGame_test} className="button">Start Game</button>
            {/* Button to start the game */}
            <button onClick={handleLeaveLobby} className="button">Leave Lobby</button>
